...
public interface ISQL {
                ...
                IF NOT bPartition THEN
                  ...
                  LOOP
                     ...
                     IF bVerbose THEN
                       ...
                       SELECT pg_get_coldef(in_schema, in_table,v_colrec.column_name,false) INTO v_diag1;
                     ...
                     ELSEIF v_colrec.udt_name in ('geometry', 'box2d', 'box2df', 'box3d', 'geography', 'geometry_dump', 'gidx', 'spheroid', 'valid_detail') THEN
            		     ...
            		     ELSEIF v_colrec.data_type = 'ARRAY' THEN
            		         ...
            		         v_temp = pg_get_coldef(in_schema, in_table,v_colrec.column_name,false);
    ...
    String DROP_TYPE_SQL = "DROP TYPE IF EXISTS %s.%s CASCADE;";
}
