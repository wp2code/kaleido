 ...
 * @date 2024-01-18
 **/
public class ControllerTemplateParserImpl extends AbsTemplateParser<JavaControllerConfigVO> {
    ...
    protected Map<String, Object> doBuildTemplateParams(final String codeName, final JavaControllerConfigVO javaControllerConfig,
        ...
        final List<String> apiList = codeGenerationTableParam.getWebApiList();
